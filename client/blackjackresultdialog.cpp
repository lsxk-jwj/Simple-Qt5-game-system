...
void BlackjackResultDialog::setMessage(int result, QLabel* result_label, QString& balance){
    ...
    static const QString tie_mesg = QString("<font color=grey>There is a tie</font>");

    static const QString win_bal_mesg =
       QString("<font color=green> +") + QString::number( Config::BlackjackBet / 2 ) + QString("  </font>");
    static const QString tie_bal_mesg =
       QString("<font color=grey> +0</font>");
    static const QString lose_bal_mesg =
       QString("<font color=red> -") + QString::number( Config::BlackjackBet / 2 ) + QString("  </font>");
